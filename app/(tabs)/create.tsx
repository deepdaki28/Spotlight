...
export default function CreateScreen() {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      if(uploadResult.status !== 200) throw new Error("Upload Falied");
    ...
    <KeyboardAvoidingView
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.header}>
          ...
          <ScrollView contentContainerStyle={styles.scrollContent} bounces={false} keyboardShouldPersistTaps="handled" contentOffset={{x:0, y:100}}>
                ...
                {/* Input Section */}
                  <View style={styles.inputSection}>
                    <View style={styles.captionContainer}>
                      ...
                      placeholderTextColor={COLORS.grey} multiline value={caption}
                      onChangeText={setCaption} editable={!isSharing}/>
                    </View>
                  </View>
              </View>
          </ScrollView>
